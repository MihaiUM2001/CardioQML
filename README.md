...
│   ├── Statistics/                 # Statistical analysis and generated figures
...
ViewClassification/
├── Statistics/
│   ├── Figures/                                # Figures generated by the statistics notebook
│   └── ViewClassification_Statistics.ipynb     # Notebook for statistical analysis and evaluation
├── VC_Default/
...
\* Not shared in the repository due to privacy constraints.
